...
// NOTE: This should match the logic in qv4targetplatform_p.h!
    ...
    && (defined(Q_OS_WIN) || defined(Q_OS_LINUX) || defined(Q_OS_QNX) || defined(Q_OS_FREEBSD)/* || defined(Q_OS_HTML5)*/)
#  define V4_ENABLE_JIT
#elif defined(Q_PROCESSOR_X86_64) && (QT_POINTER_SIZE == 8) \
    && (defined(Q_OS_WIN) || defined(Q_OS_LINUX) || defined(Q_OS_MAC) || defined(Q_OS_FREEBSD)/* || defined(Q_OS_HTML5)*/)
#  define V4_ENABLE_JIT
